...
const Card = ({elem}) => {
  ...
  return (
    <div onClick={() => navigate(`/${elem.availableOn}/${elem.slug}`)} className='w-[280px] cursor-pointer text-white flex flex-col gap-2 hover:text-red-600 transition-all ease duration-300'>
