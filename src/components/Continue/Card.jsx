...
const Card = ({elem}) => {
  return (
    <div>
      <div style={{backgroundImage:`url(${elem.poster})`}}  className="text-white min-w-[280px] gap-2 flex flex-col justify-end snap-start h-[180px] p-4 rounded-xl  flex-shrink-0 bg-cover bg-top ">
