...
const Card = ({elem}) => {
  ...
  return (
    <div onClick={() => navigate(`/${elem.availableOn}/${elem.slug}`)} className='snap-start cursor-pointer  min-w-[250px] text-white flex flex-col gap-2 rounded-2xl hover:text-red-600 transition-all ease duration-300 '>
