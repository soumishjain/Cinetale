...
const Card = ({elem}) => {
  ...
  return (
    <div onClick={() => navigate(`/${elem.availableOn}/${elem.slug}`)} className='min-w-[280px] cursor-pointer  flex flex-col text-white  gap-2 hover:text-red-600 transition-all ease duration-300'>
