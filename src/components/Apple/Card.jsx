...
const Card = ({elem}) => {
  ...
  return (
    <div onClick={() => navigate(`/${elem.availableOn}/${elem.slug}`)} className='snap-start cursor-pointer  min-w-[150px] sm:min-w-[250px] flex flex-col text-white gap-2 hover:text-red-600 transition-all ease duration-300'>
