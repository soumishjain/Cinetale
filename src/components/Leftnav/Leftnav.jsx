...
const Leftnav = () => {
  ...
  return (
    <div className='border-2 hidden sm:flex flex-col sm:justify-between rounded-xl border-white/40 w-[100%] h-full bg-black/20  py-4 px-3'>
      ...
      <div className='flex flex-col gap-3'>
        <div className="top flex gap-3 border-white/40 border-b-2 pb-4 flex-wrap sm:flex-col sm:gap-0">
      ...
      <div className="mid flex gap-3 border-white/40 border-b-2 pb-4 flex-wrap sm:flex-col sm:gap-0">
      ...
      <div className='flex justify-start mb-1 sm:mt-40 text-white/40 items-center gap-2'>
