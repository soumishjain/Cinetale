...
const Card = ({elem}) => {
  ...
  return (
    <div onClick={() => navigate(`/genre/${elem.genre.toLowerCase()}`)} style={{backgroundImage: `url(${elem.poster})`}} className='min-w-[280px] h-[180px]  rounded-xl bg-center bg-cover cursor-pointer '>
